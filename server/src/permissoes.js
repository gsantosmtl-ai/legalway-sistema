...
const MAPA = {
  ...
  'legalway-contratos-v1':              { modulos: ['contratos', 'funil', 'financeiro'], leitura: ['documentos', 'clientes', 'processos'] },
  'legalway-clientes-v1':               { modulos: ['clientes', 'contratos', 'documentos'], leitura: ['tarefas', 'agenda', 'financeiro', 'funil', 'sdr', 'processos'] },
  // dinheiro: Documentação só LÊ (precisa do % pago pra liberar protocolo); quem grava é Financeiro e Contratos
  'legalway-financeiro-v1':             { modulos: ['financeiro', 'contratos'], leitura: ['documentos'] },
  'legalway-contas-pagar-v1':           { modulos: ['financeiro', 'documentos'] },
  'legalway-orcamento-v1':              { modulos: ['financeiro'] },
  'legalway-uscis-v1':                  { modulos: ['documentos', 'processos'] },
  'legalway-contas-bancarias-v1':       { modulos: ['financeiro'] },
  'legalway-categorias-financeiro-v1':  { modulos: ['financeiro'] },
  // Clientes só lê os processos (a tela não grava); Financeiro grava porque libera o protocolo ao receber
  'legalway-processos-documentacao-v1': { modulos: ['documentos', 'processos', 'financeiro'], leitura: ['clientes'] },
